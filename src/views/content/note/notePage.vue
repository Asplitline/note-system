<template>
  <el-row class="note-page" :gutter="30">
    <el-col class="header" :lg="6" :xs="24">
      <el-form ref="postForm" :model="postForm" :rules="postRules" status-icon label-width="0" class="form">
        <div class="img">
          <el-form-item prop="coverImage">
            <el-upload
              ...
              :data="{ owerId: userId }"
            >
              <img v-if="postForm.coverImage" :src="_url(postForm.coverImage)" class="avatar" />
        ...
        <div class="ipt">
          <el-form-item prop="lx">
            <el-select v-model="postForm.lx" placeholder="请选择所属分类" filterable>
          ...
          <el-form-item prop="title">
            <el-input v-model="postForm.title" placeholder="请输入笔记标题" />
          </el-form-item>
        </div>
      </el-form>
    </el-col>
    <el-col class="content" :lg="18" :xs="24">
      <div class="wrapper">
        ...
        <div class="t-btns">
          <el-button type="info" class="t-btn" @click="back">
            返回
          </el-button>
