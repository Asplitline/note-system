  ...
  <div class="login-container">
    ...
    >
      ...
      <div class="login-btns t-btns">
        <el-button type="info" class="login-btn" @click="toggleBtn">
          注册
        </el-button>
        <el-button :loading="loading" type="success" class="login-btn" @click.native.prevent="handleLogin('loginForm')">
          登录
        </el-button>
      </div>
    </el-form>
    ...
    >
      ...
      <el-form-item prop="username">
        ...
        <el-input ref="username" v-model="registerForm.username" placeholder="用户名" name="username" type="text" tabindex="1" />
      </el-form-item>
      ...
      <div class="login-btns t-btns">
        ...
        <el-button :loading="loading" type="success" class="login-btn" @click.native.prevent="handleLogin('registerForm')">
          注册
        </el-button>
      </div>
    </el-form>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      registerRules: {
        username: [{ required: true, trigger: 'blur', message: '请输入用户名' }],
        oldPassword: [{ required: true, trigger: 'blur', message: '请输入新密码' }],
  ...
  methods: {
    ...
    toggleBtn() {
      this.toggle ? this.$refs.loginForm.resetFields() : this.$refs.registerForm.resetFields()
          ...
          this['user/login'](this[formName])
            .then(({ success, message, data }) => {
              ...
              if (success) {
                ...
                isAuth ? this.$router.push({ name: 'Home' }) : this.$router.push({ name: 'pIndex' })
              }
